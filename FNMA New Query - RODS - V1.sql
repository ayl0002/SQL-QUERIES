...
SELECT tab1.*,[GRP_DESC],[FNM_APRV_DTTM],[FNM_APRV_RQST_DTTM],[FNM_DND_DTTM],tab3.[HUD_STS_DESC],DATE_SUBMIT_TO_HUD,Claim_Filed--,[Jan-20_MCA%],[FEB-20_MCA%],[MAR-20_MCA%],[APR-20_MCA%],[May-20_MCA%]
/*,CASE WHEN DATEPART(MONTH,CLAIM_FILED) = 1 AND DATEPART(YEAR,CLAIM_FILED) = 2020 THEN [Jan-20_MCA%]
...
SELECT A.LOAN_NBR,	A.FHA_CASE_NBR,	A.INVESTOR_LOAN_NBR,	A.STATUS_CODE,	A.STATUS_DESCRIPTION,	A.INVESTOR,	A.MAX_CLAIM_AMOUNT,	A.MCA_PERCENT, A.LOAN_STATUS_CATEGORY,	A.LOAN_STATUS,	A.POOL_NAME,	A.FNM_APRV_DTTM,	A.FNM_APRV_RQST_DTTM,	A.FNM_DND_DTTM,	A.HUD_STS_DESC,	A.DATE_SUBMIT_TO_HUD,--	A.POR_EXCP_ID,	A.POR_DOC_DESC,	A.POR_EXCP_STS_DESC,	A.POR_EFF_DTTM,	A.INCUR_EXCP_ID,	A.INCUR_DOC_DESC,	A.INCUR_EXCP_STS_DESC,	A.INCUR_EFF_DTTM
...
SELECT B.loan_nbr,C.MCA_PERCENT,B.Excp_ID,B.[DOC_DESC],EXCP_AGGREGATE,B.EXCP_STS_DESC,B.EFF_DTTM,B.TRUE_CLOSE,B.TRUE_OPEN,B.DAYS_TO_CLOSE,B.TAX_VENDOR,B.HOA_VENDOR,GFT_CRD_LTR_SNT_DTTM,GFT_CRD_LTR_SNT_2_DTTM,GFT_CRD_LTR_SNT_3_DTTM,SNT_FR_GFT_CRD_PROC_DTTM,SNT_TO_INSPT_VNDR_DTTM
...
ON B.LOAN_NBR = C.LOAN_NBR
 ...
 --SELECT * FROM DROP TABLE ##NEW_FNMA_BASE_EXCP
 SELECT * FROM ##NEW_FNMA_BASE

--DROP TABLE #BASE,#BASE2,#BASE3,#EXCP,#EXCP1,#PreApproved
